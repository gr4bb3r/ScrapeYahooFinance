...
holdings = data.frame('Overall_Portfolio_Composition' = NA, 'Overall_Portfolio_Composition' = NA,
                      ...
                      'Equity_Holdings' = NA, 'Bond_Ratings' = NA, 'Bond_Ratings' = NA)
...
####Scraping & Carpentry####
url = 'https://finance.yahoo.com/quote/VFV.TO/holdings?p=VFV.TO'
...
bnd_hldgs_end_pos = stringr::str_locate(equity_data,"Top 1 Holdings")
